...
intersectBed -a hervh.merged.bed -b <(cut -f 6-8,10 ../../data/annotation/hg19.HERVH-int.txt) -wo > hervh_beds/hervh.merged.overlap_orig.tmp
Rscript assign_hervh_strand.r

awk -v OFS="\t" '{print $1,$2-1000,$3+1000,$4}' hervh.merged.bed > hervh.ext1k.bed
awk -v OFS="\t" '{print $1,$2-20000,$3+20000,$4}' hervh.merged.bed > hervh.ext20k.bed
