...
a2 = read.delim("Input.for_cohesin.D00.rpkm.bw.mat.gz",skip=1,header=F)
a2 = a2[match(a$V4,a2$V4),]
a[,-c(1:6)] = a[,-c(1:6)] -a2[,-c(1:6)]
...
write.table(tl2,paste0(name,".smoothed.-Input.mat"),row.names=F,col.names=F,quote=F,sep='\t')
