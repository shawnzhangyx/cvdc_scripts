...
pdf("figures/regulated_genes_on_5p3p_of_HERVH.TADs.pdf",height=4,width=4)
ggplot(comb) + geom_boxplot(aes(x=type,fill=variable,y=value)) +
  annotate(geom="text",x=c(1,2),y=c(100,100),label=c("p=0.022","p=0.67"))+
  xlab("") + ylab("RPKM") + 
  scale_y_log10(breaks=c(0.1,1,10,100)) +
  scale_x_discrete(labels=c("5'LTR (N=43)","3'LTR (N=28)")) + 
  theme( 
