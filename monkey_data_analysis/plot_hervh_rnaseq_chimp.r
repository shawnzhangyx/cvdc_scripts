...
a=read.delim("rnaseq/panTro6.hervh.rnaseq.counts",skip=1,stringsAsFactors=F)
b=read.delim('../../data/rnaseq_pipe/panTro6/combined-chrM.counts',skip=1,stringsAsFactors=F)
