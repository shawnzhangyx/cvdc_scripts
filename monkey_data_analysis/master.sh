...
grep HERVH-int ~/annotations/bonobo/repeatmasker/rmsk.txt |cut -f 6-8 |sort -k1,1 -k2,2n | mergeBed -d 1000 -i - | awk -v OFS="\t" '{print $0,$1":"$2"-"$3}' > panPan2.hervh.merged.bed
...
awk -v OFS="\t" '{print $4,$1,$2,$3,$6}' panPan2.hervh.merged.bed > panPan2.hervh.merge.saf
...
bonobo=../../data/rnaseq_pipe/panPan2/bam/*.bam
featureCounts -a panPan2.hervh.merge.saf -o rnaseq/panPan2.hervh.rnaseq.counts $bonobo -F SAF -T 8
