pushd ../../analysis/gWAS/
intersectBed -a ../../data/atac/peaks/atac_merged_peaks.bed -b ../../data/gWAS/heartgwasLDcommonSNP.bed -wo > gWAS.overlap_atac.txt
intersectBed -a ../../data/atac/peaks/atac_distal_peaks.bed -b ../../data/gWAS/heartgwasLDcommonSNP.bed -wo > gWAS.overlap_atac_distal.txt
