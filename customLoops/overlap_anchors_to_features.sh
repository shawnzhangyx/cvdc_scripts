...
intersectBed -b ../../data/atac/peaks/atac_merged_peaks.bed -a anchors/anchors.uniq.30k.bed -loj -f 0.5 -F 0.5 -e > $outdir/anchor.atac_merged_peaks.txt
intersectBed -b ../../data/tfChIPseq/merged_peaks/CTCF_merged_peaks.bed -a anchors/anchors.uniq.30k.bed -loj -f 0.5 -F 0.5 -e > $outdir/anchor.CTCF_merged_peaks.txt

for mark in H3K4me1 H3K4me3 H3K27ac H3K27me3; do
intersectBed -b $chipdir/${mark}_merged_peaks.bed -a anchors/anchors.uniq.30k.bed -loj -f 0.5 -F 0.5 -e > $outdir/anchor.${mark}_merged_peaks.txt
done
