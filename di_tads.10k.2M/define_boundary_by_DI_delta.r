...
a = a[-which( rowSums(a[,seq(2,25,2)]<2)>0),]
...
colnames(a2) = colnames(a)[c(1,seq(3,25,2))]
a2$max = apply(a2[,2:13],1,max)
...
b$D07 = grepl("D07",b$V3)
b$D15 = grepl("D15",b$V3)
b$D80 = grepl("D80",b$V3)

true = as.numeric(unlist(a2[,c(2:13)])[unlist(b[,rep(6:11,each=2)])])

false = as.numeric( unlist(a2[,c(2:13)])[unlist(!b[,rep(6:11,each=2)])])
