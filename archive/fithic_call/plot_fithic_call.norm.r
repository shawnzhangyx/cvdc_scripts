...
setwd("/mnt/silencer2/home/yanxiazh/projects/cardiac_dev/analysis/fithic/")
system("mkdir myh67_locus")
setwd("myh67_locus")
data_list = list()
for (name in readLines("/mnt/silencer2/home/yanxiazh/projects/cardiac_dev/data/hic/meta/names.txt")){
print(name)
data = data.frame(fread(paste0("zcat /mnt/silencer2/home/yanxiazh/projects/cardiac_dev/analysis/fithic/results/",name,"/14.norm.spline_pass2.significances.txt.gz")))
