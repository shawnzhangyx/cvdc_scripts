...
files=list.files(path="../../data/hic/DI",pattern="10000.200.DI.bedGraph$",full.names=T)[1:6]
...
colnames(mat)[4:9] = sub(".*\\/(.*).10000.200.DI.bedGraph","\\1",files)

eq0 = mat[,4:9]==0
num_Eq0 = rowSums(eq0)

mat2 = mat[which(num_Eq0<6),]

library(preprocessCore)
qtl = normalize.quantiles(as.matrix(mat2[,4:9]))
