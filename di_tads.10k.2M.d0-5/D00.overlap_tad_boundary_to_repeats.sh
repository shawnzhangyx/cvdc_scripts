cd  ../../analysis/di_tads.10k.2M.d0-5/dynamic_bd/
...
for repeats in $(ls ../../../data/annotation/repeats/*.txt); do
  ...
  a2=$(intersectBed -a <(awk -v OFS="\t" '{print $1,$2-50000,$2+50000}' d02.txt) -b <(tail -n +2 ../../../data/annotation/repeats/${name}.txt |cut -f 6-8)  -u |wc -l)
